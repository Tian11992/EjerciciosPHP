...
if(isset($_POST["calcular"])){
    ...
    $proyectofinal = $_POST["txtproyecto"];
    ...
    $definitiva = $valortaller1 + $valortaller2 + $valorcuestionario1 + $valorcuestionario2 + $valorproyectofinal;

    echo "La nota definitiva es: " . $definitiva;
}
